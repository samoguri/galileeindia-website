        ...
        <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <p className="text-gray-700 leading-8 mb-6">
                  ...
                  <strong> Dr.Prabhudas Oguri & Samadanam Oguri</strong> to this coastal area of
                  Visakhapatnam, Andhra Pradesh, India. At that time, it was a
                  lonely and sparsely populated place. There were no residential
                  houses nearby—only a few fishermen's huts on one side and a
                  traditional village several miles away on the other.
                </p>
                ...
                <p className="text-gray-700 leading-8 mb-6">
                  ...
                  many people had never experienced the hope and everlasting love
          ...
          <div className="bg-white rounded-2xl shadow-lg p-10 mb-12">
            ...
            <p className="text-gray-700 leading-8 mb-6">
              ...
              beginning, the church has remained committed to regular worship,
              fervent prayer, the faithful teaching of God's Word, and reaching
              surrounding communities with the love of Christ.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-10 mb-12">
            ...
            <p className="text-gray-700 leading-8">
              During school vacations we also conduct a Vacation Bible School,
              providing children with an opportunity to hear the Gospel in a
              joyful and engaging environment. We earnestly request your prayers
              for this ministry, that many young hearts may come to know and
          ...
          <div className="bg-white rounded-2xl shadow-lg p-10">
            ...
            <p className="text-gray-700 leading-8 mb-6">
              Over the years, the once-deserted area has developed into one of
              the largest residential neighborhoods in Visakhapatnam. The nearby
              fishing communities have also grown significantly.
            </p>
            ...
            <p className="text-gray-700 leading-8 mb-6">
              ...
              Gospel, we seek to demonstrate Christ's love by extending
              practical help to underprivileged families whenever possible.
            </p>

            <p className="text-blue-900 font-semibold text-lg leading-8">
              By God's grace, we remain committed to proclaiming the Good News
              of Jesus Christ, nurturing believers, serving our community, and
              making His love known to future generations.
            </p>
